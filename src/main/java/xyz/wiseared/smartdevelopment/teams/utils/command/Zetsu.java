...
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.adapters.*;
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.adapters.defaults.*;
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.permissible.PermissibleAttachment;
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.permissible.impl.permissible.BukkitPermissionAttachment;
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.permissible.impl.permissible.Permissible;
import xyz.wiseared.smartdevelopment.warsimulator.utils.command.processor.bukkit.BukkitCommand;
